    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.grid}>
        <TouchableOpacity style={styles.card}>
          <IconSymbol name="airplane" size={40} color="black" />
          <Text style={styles.cardText}>FLIGHTS</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card}>
          <IconSymbol name="building.2" size={40} color="black" />
          <Text style={styles.cardText}>HOTELS</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card}>
          <IconSymbol name="sun.max" size={40} color="black" />
      ...
      <View style={styles.promoContainer}>
        <View style={styles.promoCardBlue}>
          <View style={styles.promoHeader}>
            <Text style={styles.promoHeaderText}>HOLIDAYS</Text>
          ...
          <View style={styles.promoBody}>
            ...
            <Text style={styles.promoSubText}>
              On all Domestic hotels - On all Credit & Debit cards
            </Text>
          </View>
        </View>
        <View style={styles.promoCardRed}>
          <View style={styles.promoHeader}>
            <Text style={styles.promoHeaderText}>FLIGHTS</Text>
          </View>
          <View style={styles.promoBody}>
            <Text style={styles.promoText}>GET 10%OFF</Text>
            <Text style={styles.promoSubText}>On Air Asia flight credit cards</Text>
          </View>
        </View>
      </View>
    </ScrollView>
